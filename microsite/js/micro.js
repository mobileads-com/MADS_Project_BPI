...
var bpi = function() {
    ...
    var first = {
        ...
        view: function () {
            return m('div#first', [
                ...
                m('div#manila', {config: persistent}, m('img', {src:  'img/manila.png'}))
            ])
        }
    };
    ...
    var second = {
        ...
        view: function (ctrl) {
            return m('div#second', [
                ...
                m('div#hotspots', m('img', {src:  'img/hotspots.png'})),
                ...
                m('div.modal', {'aria-hidden': true}, m('div.modal-dialog', [
                        ...
                        m('div.modal-body', [
                            ...
                            m('img#smallmap.map', {src: selected.map ||  'img/loading.gif'}),
                            //m('div#smallMap'),
                            m('a.download', {
    ...
    document.getElementById('rma-widget').innerHTML = '<div id="bpiad" class="bpiad"></div>';
